...
public class Packet_move extends Comp1 implements ActionListener{
	...
	public void music()
	{
		...
		{
			try {
				startsound = getAudioClip(getDocumentBase(),"D:/ASHSIH/PROJECTS/JAVA/Step1.wav");
				startsound.play();
		...
		{
			try {
				startsound = getAudioClip(getDocumentBase(),"D:/ASHSIH/PROJECTS/JAVA/Step2.wav");
				startsound.play();
				}
				catch(Exception e) {}
		}
		...
		{
			try {
				startsound = getAudioClip(getDocumentBase(),"D:/ASHSIH/PROJECTS/JAVA/Step3.wav");
				startsound.play();
				}
				catch(Exception e) {}
		}
		...
		{
			try {
				startsound = getAudioClip(getDocumentBase(),"D:/ASHSIH/PROJECTS/JAVA/Step4.wav");
				startsound.play();        
				}
				catch(Exception e) {}
		}
	...
	private AudioClip getAudioClip(Object documentBase, String string) {
	...
	public void paintComponent(Graphics g)
	{
		...
		else if(flag==-1| flag==0 |  flag==1 | flag==2 |flag==3)
		{
			g.setColor(Color.RED);
			g.fillOval(x, y, 10,10);
			g.fillOval(c,d,10,10);
		...
		else if(flag==4)
		{
			...
			g.drawString("2. WMFC",25,460);
			g.drawString("3. MDRoutb,R=B,IRin",25,490);
			g.drawString("4. R2outb,R=B,Read,MARin",25,520);
		}
		...
		else if(flag==7)
		{
			...
			g.drawString("4. R2outb,R=B,Read,MARin",25,520);
			g.drawString("5. WFMC",25,550);
			g.drawString("6. MDRoutb, R=B, R1in",25,580);
		}
		else if(flag==8)
		{
			t.stop();
	...
	{
		if(y==410 & x==640 & flag==4)
		{
			x=620;
			y=125;
			repaint();
		}
		else if(y==125 & x>=430 & flag==4)
		{
			if(done==4)
			{
				pause=1;
		...
		else if(x==429 & y<297 & flag==4)
		{
			y=y+vel;
			repaint();
		}
		//R=B
				else if(x<600 & y==297 & flag==4)
				{
					x = x +vel;
					repaint();
				}
				else if(x==600 & y>265 & flag==4)
				{
					y=y-vel;
					repaint();
				}
				else if(y==265 & x<753 & flag==4)
				{
					x=x+vel;
					repaint();
				}
				else if(x==753 & y<520 & y>264 & flag==4)
				{
					y=y+vel;
					repaint();
		...
		//WMFC
				else if(x==630 & y<620 & y>519 & flag==5)
				{
					y=y+vel;
					repaint();
				}
				...
				else if(x==520 & y>495 & flag==6)
				{
					y=y-vel;
					repaint();
				}
				else if(y==495 & x<628 & flag==6)
				{
					x=x+vel;
					repaint();
				}
				...
				//MRDoutb
				else if(y==445 & x>427 & flag==7)
				{
					x=x-vel;
					repaint();
				}
				else if(x==427 & y>297 & flag==7)
				{
					y=y-vel;
					repaint();
				}
				//R=B
				else if(x<600 & y==297 & flag==7)
				{
					x = x +vel;
					repaint();
				}
				else if(x==600 & y>265 & flag==7)
				{
					y=y-vel;
					repaint();
				}
				else if(y==265 & x<753 & flag==7)
				{
					x=x+vel;
					repaint();
				}
				else if(y>140 & x==753 & flag==7)
				{
					y=y-vel;
					repaint();
				}
				else if(y==140 & x>635 & flag==7)
				{
					x = x-vel;
					repaint();
				}
